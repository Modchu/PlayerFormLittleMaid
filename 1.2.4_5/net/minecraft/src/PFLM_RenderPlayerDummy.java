...
public class PFLM_RenderPlayerDummy extends RenderPlayer
{
	...
	public static Modchu_ModelDuo modelMain;
	public static Modchu_ModelDuo modelFATT;
	...
	public PFLM_RenderPlayerDummy() {
		super();
		modelMain = new Modchu_ModelDuo(this);
		...
		modelFATT = new Modchu_ModelDuo(this);
...
//@-@b181
    ...
    public void doRender(Entity entity, double d, double d1, double d2,
    	...
    	((Modchu_ModelBiped) modelFATT.modelArmorOuter).isWait = ((Modchu_ModelBiped) modelFATT.modelArmorInner).isWait = ((Modchu_ModelBiped) modelMain.modelArmorInner).isWait;
