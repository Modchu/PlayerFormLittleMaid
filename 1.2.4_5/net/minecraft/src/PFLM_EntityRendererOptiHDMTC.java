...
public class PFLM_EntityRendererOptiHDMTC extends EntityRenderer {
    ...
    public PFLM_EntityRendererOptiHDMTC(Minecraft par1Minecraft)
    {
        super(par1Minecraft);
        mc = par1Minecraft;
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var20 = 0; var20 < 2; ++var20)
        {
            ...
            setupCameraTransform(par1, var20);
            ...
            mc.renderGlobal.clipRenderersByFrustum(var19, par1);
            ...
            if (var20 == 0)
            {
                ...
                {
                    long var22 = par2 - System.nanoTime();

                    if (var22 < 0L || (double)var22 > 1.0E9D)
                    {
                        break;
                    }
                }
            ...
            boolean var21 = Reflector.hasClass(1);
            ...
            if (debugViewDirection == 0)
            {
                ...
                if (mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !mc.gameSettings.hideGUI)
                {
                    ...
                    if (!var21 || !Reflector.callBoolean(10, new Object[] {var5, var17, mc.objectMouseOver, Integer.valueOf(0), var17.inventory.getCurrentItem(), Float.valueOf(par1)}))
                    {
            ...
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture("/terrain.png"));
            UpdateThread var23 = Config.getUpdateThread();
            ...
            {
                EntityPlayer var24 = (EntityPlayer)var4;
                GL11.glDisable(GL11.GL_ALPHA_TEST);
                Profiler.endStartSection("outline");

                if (!var21 || !Reflector.callBoolean(10, new Object[] {var5, var24, mc.objectMouseOver, Integer.valueOf(0), var24.inventory.getCurrentItem(), Float.valueOf(par1)}))
                {
                    var5.drawBlockBreaking(var24, mc.objectMouseOver, 0, var24.inventory.getCurrentItem(), par1);

                    if (!mc.gameSettings.hideGUI)
                    {
                        var5.drawSelectionBox(var24, mc.objectMouseOver, 0, var24.inventory.getCurrentItem(), par1);
                    }
                }
                GL11.glEnable(GL11.GL_ALPHA_TEST);
            }
