...
public class PFLM_EntityRenderer2D extends EntityRenderer {
	...
	public PFLM_EntityRenderer2D(Minecraft par1Minecraft)
    {
        super(par1Minecraft);
    ...
    private void orientCamera(float par1)
    {
    	...
    	if ((Boolean) Modchu_Reflect.getFieldObject(mod_PFLM_PlayerFormLittleMaid, "isThirdPersonCamera")) {
    		try {
    			camRoll = (Float) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getPrivateValue", new Class[]{ Class.class, Object.class, int.class}, new Object[]{ EntityRenderer.class, this, 26 });
    		} catch (Exception e) {
    			try {
    				camRoll = (Float) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getPrivateValue", new Class[]{ Class.class, Object.class, String.class}, new Object[]{ EntityRenderer.class, this, "camRoll" });
    			} catch (Exception e1) {
    				e1.printStackTrace();
    			}
    		}
        ...
        else if (mc.gameSettings.thirdPersonView > 0)
        {
        	if ((Boolean) Modchu_Reflect.getFieldObject(mod_PFLM_PlayerFormLittleMaid, "isThirdPersonCamera")) {
        		try {
        			thirdPersonDistance = (Float) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getPrivateValue", new Class[]{ Class.class, Object.class, int.class}, new Object[]{ EntityRenderer.class, this, 13 });
        		} catch (Exception e) {
        			try {
        				thirdPersonDistance = (Float) Modchu_Reflect.invokeMethod(mod_PFLM_PlayerFormLittleMaid, "getPrivateValue", new Class[]{ Class.class, Object.class, String.class}, new Object[]{ EntityRenderer.class, this, "thirdPersonDistance" });
        			} catch (Exception e1) {
        				e1.printStackTrace();
        			}
        		}
