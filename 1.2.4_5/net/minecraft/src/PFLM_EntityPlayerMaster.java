...
public class PFLM_EntityPlayerMaster {
	...
	public PFLM_EntityPlayerMaster(EntityPlayerSP entity) {
		player = entity;
...
//@-@b181
    ...
    public void copyPlayer(EntityPlayer entityplayer)
    {
    	...
    	if (player != null) {
    		Modchu_Reflect.invokeMethod(player.getClass(), "supercopyPlayer", new Class[]{ EntityPlayer.class }, player, new Object[]{ entityplayer });
    		return;
    	}
