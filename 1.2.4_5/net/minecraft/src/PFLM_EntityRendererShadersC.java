...
public class PFLM_EntityRendererShadersC extends EntityRenderer {
    ...
    public PFLM_EntityRendererShadersC(Minecraft par1Minecraft)
    {
        super(par1Minecraft);
        mc = par1Minecraft;
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        while (true)
        {
            ...
            setupCameraTransform(par1, var27);
            Object var23 = null;
            ...
            var26.setPosition(var7, var9, var11);
            mc.renderGlobal.clipRenderersByFrustum(var26, par1);
            ...
            if (var27 == 0)
            {
                ...
                {
                    long var29 = par2 - System.nanoTime();

                    if (var29 < 0L || (double)var29 > 1.0E9D)
                    {
                        break;
                    }
                }
            ...
            if (var22 == 0)
            {
                ...
                var33 = var5.sortAndRender(var4, var22, var32);
                Shaders.endTerrain();
            }
            else if (var22 == 1)
            {
            ...
            boolean var28 = Reflector.hasClass(1);
            EntityPlayer var17;
            ...
            if (debugViewDirection == 0)
            {
                ...
                var5.renderEntities(var4.getPosition(par1), var26, par1);
                enableLightmap((double)par1);
                ...
                if (mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !mc.gameSettings.hideGUI)
                {
                    ...
                    if (!var28 || !Reflector.callBoolean(10, new Object[] {var5, var17, mc.objectMouseOver, Integer.valueOf(0), var17.inventory.getCurrentItem(), Float.valueOf(par1)}))
                    {
            ...
            if (Config.isWaterFancy())
            {
                ...
                int var30 = var5.renderAllSortedRenderers(1, (double)par1);
