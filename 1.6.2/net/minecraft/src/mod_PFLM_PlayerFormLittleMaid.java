...
public class mod_PFLM_PlayerFormLittleMaid extends BaseMod
{
	...
	public mod_PFLM_PlayerFormLittleMaid()
	{
		...
		if (getVersion().startsWith("1.6.2")) {
			playerFormLittleMaidVersion = 162;
...
*///b173delete
    ...
    public static void changeModel(AbstractClientPlayer entityplayer) {
    ...
    public static void changeColor(AbstractClientPlayer entityplayer) {
    	if (entityplayer != null) ;else entityplayer = mc.thePlayer;
    	PFLM_ModelData data = PFLM_RenderPlayer.getPlayerData(entityplayer);
    	if (data != null
    			&& data.getCapsValueBoolean(data.caps_isPlayer)) {
...
//-@-b166
    		if (isPlayerAPI
    				&& !isPlayerAPIDebug) {
    			Modchu_Reflect.invokeMethod(PFLM_PlayerBase, "setPlayerTexture", new Class[]{String.class}, mc.thePlayer, t);
    		} else {
/*
    			if (isSSP) {
...
*/
//@-@b166
    			Modchu_Reflect.invokeMethod(PFLM_EntityPlayerSP.class, "setPlayerTexture", new Class[]{String.class}, mc.thePlayer, t);
    		/*b166//*/}
    	}
    }
...
*/
    ...
    public static float getModelScale(Entity entity) {
    	...
    	Object textureModel = PFLM_RenderPlayer.getPlayerData((AbstractClientPlayer) entity).modelMain.model;
...
//@-@b166
    ...
    public static Object getModel(AbstractClientPlayer entityPlayer, int i) {
	...
	public static void setMaidColor(AbstractClientPlayer entityplayer, int i) {
		if (entityplayer != null) ;else entityplayer = mc.thePlayer;
		PFLM_ModelData data = PFLM_RenderPlayer.getPlayerData(entityplayer);
		if (data != null) {
