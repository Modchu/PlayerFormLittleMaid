		...
		if (setting) {
			...
			if(t[4] != null) {
				if (Integer.valueOf(t[4]) == PFLM_GuiOthersPlayerIndividualCustomize.modeOthersSettingOffline) {
					// 152delete((PFLM_EntityPlayerDummy) entityliving).texture = mod_Modchu_ModchuLib.textureManagerGetTexture(t[0], Integer.valueOf(t[2]));
	    			PFLM_RenderPlayerDummy.modelData.setCapsValue(PFLM_RenderPlayerDummy.modelData.caps_ResourceLocation, 0, mod_Modchu_ModchuLib.textureManagerGetTexture(t[0], Integer.valueOf(t[2])));
