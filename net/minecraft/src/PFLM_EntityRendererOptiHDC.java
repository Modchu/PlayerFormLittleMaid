...
public class PFLM_EntityRendererOptiHDC extends EntityRenderer {
    ...
    public PFLM_EntityRendererOptiHDC(Minecraft par1Minecraft)
    {
        super(par1Minecraft);
        mc = par1Minecraft;
        ...
        for (int var19 = 0; var19 < 2; ++var19)
        {
            ...
            if (var19 == 0)
            {
                ...
                while (!mc.renderGlobal.updateRenderers(var4, false) && par2 != 0L)
                {
                    ...
                    if (var21 < 0L || (double)var21 > 1.0E9D)
                    {
                        break;
                    }
                }
            ...
            boolean var20 = Reflector.hasClass(1);
            EntityPlayer var17;
            ...
            if (debugViewDirection == 0)
            {
                ...
                if (mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !mc.gameSettings.hideGUI)
                {
                    ...
                    if (!var20 || !Reflector.callBoolean(10, new Object[] {var5, var17, mc.objectMouseOver, Integer.valueOf(0), var17.inventory.getCurrentItem(), Float.valueOf(par1)}))
                    {
            ...
            if (Config.isWaterFancy())
            {
                ...
                int var22 = var5.renderAllSortedRenderers(1, (double)par1);
