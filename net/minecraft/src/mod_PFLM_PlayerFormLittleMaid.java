...
public class mod_PFLM_PlayerFormLittleMaid extends BaseMod
{
	...
	public void load()
	{
		...
		if (o != null) {
			Modchu_Reflect.invokeMethod(MMM_TextureManager, "addSearch", new Class[]{String.class, String.class, String.class}, o, new Object[]{"playerformlittlemaid", "/assets/minecraft/textures/entity/littleMaid/", mod_Modchu_ModchuLib.modelClassName+"_"});
			Modchu_Reflect.invokeMethod(MMM_TextureManager, "addSearch", new Class[]{String.class, String.class, String.class}, o, new Object[]{"playerformlittlemaid", "/assets/minecraft/textures/entity/littleMaid/", mod_Modchu_ModchuLib.modelClassName+"_"});
		} else {
...
//-@-125
		...
		if (!isAether) {
			...
			//else
				...
				var1 = new PFLM_RenderPlayerV160();
				//isModelSize
				//if (isPlayerAPI
				...
				try {
					var1 = (PFLM_IRenderPlayer) Modchu_Reflect.newInstance("PFLM_RenderPlayer2", null, null);
					map.put(EntityClientPlayerMP.class, var1);
					map.put(EntityOtherPlayerMP.class, var1);
...
*/
	...
	public void playerControllerReplace() {
		...
		EntityPlayer var9 = getThePlayer();
		...
		if (isPlayerAPI
			...
			if (!((PFLM_EntityPlayerSP) thePlayer).initFlag) ((PFLM_EntityPlayerSP) thePlayer).init();
		}
		setPosition(x, y, z);
	}
	...
	public static void mushroomConfusion(EntityPlayer entityplayer, PFLM_ModelData modelData) {
		...
		//if(getPFLMVersion() > 79) boolean mushroomConfusionResetFlag = true;
		if (itemstack != null) {
				...
				if (block instanceof BlockMushroom) {
					...
					if (itemstack2 != null) {
						...
						if (item2 == item.dyePowder) {
							//if(getPFLMVersion() > 79) mushroomConfusionResetFlag = false;
...
*/
//@-@b166
    		Modchu_Reflect.invokeMethod(PFLM_EntityPlayerSP.class, "setPositionCorrection", new Class[]{ double.class, double.class, double.class }, thePlayer, new Object[]{ x, y, z });
    	/*b166//*/}
    }
...
*/
//@-@b166
    			Modchu_Reflect.setFieldObject(PFLM_EntityPlayerSP.class, "skinUrl", thePlayer, s);
    		/*b166//*/}
    	}
    }
...
*/
//@-@b166
    			Modchu_Reflect.invokeMethod(PFLM_EntityPlayerSP.class, "setPlayerTexture", new Class[]{String.class}, thePlayer, t);
    		/*b166//*/}
    	}
    }
...
*/
    	pflm_renderPlayer.setResetFlag(flag);
    }
...
*/
    	pflm_renderPlayer.setTextureResetFlag(flag);
    }
    ...
    public static float getWidth() {
    	...
    	PFLM_ModelData data = pflm_renderPlayer.getPlayerData(thePlayer);
...
//@-@b166
    ...
    public static boolean getChangeModelFlag() {
    	EntityPlayer thePlayer = getThePlayer();
    	PFLM_ModelData modelData = pflm_renderPlayer.getPlayerData(thePlayer);
    ...
    public static int getHandednessMode(Entity entity) {
    	PFLM_ModelData modelData = pflm_renderPlayer.getPlayerData((EntityPlayer) entity);
    ...
    public static boolean getIsSitting() {
    	PFLM_ModelData modelData = pflm_renderPlayer.getPlayerData(Minecraft.getMinecraft().thePlayer);
...
*///125delete
	...
	{
		boolean keyFlag = getPFLMVersion() > 129 ? mod_Modchu_ModchuLib.isForge : false;
		//キーの登録と名称変換テーブルの登録
		String s;
		if (isPlayerForm) {
	...
	public void modsLoadedInit() {
		...
		else if (getPFLMVersion() > 129) ModLoader.setInGUIHook(this, true, true);
		...
		isHD = isItemRendererHD
				&& !isItemRendererDebug;
		itemRendererClass = isHD ? Modchu_Reflect.loadClass("PFLM_ItemRendererHD") : PFLM_ItemRenderer.class;
		if (isSmartMoving) {
			isModelSize = false;
...
/*//125delete
		if (isModelSize) {
			try {
				if (isCCTV) {
					String s3;
					entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererCCTV"), new Class[]{ Minecraft.class }, new Object[]{ mc });
				...
				if (is2D) {
					String s3;
					entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRenderer2D"), new Class[]{ Minecraft.class }, new Object[]{ mc });
					s3 = "PFLM_EntityRenderer2D";
					ModLoader.getLogger().fine((new StringBuilder(s3 + " to set.")).toString());
					Modchu_Debug.Debug(s3 + " to set.");
				} else
				if (erpflmCheck == 0) {
					entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRenderer"), new Class[]{ Minecraft.class }, new Object[]{ mc });
				...
				if (erpflmCheck == 1) {
					entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererForge"), new Class[]{ Minecraft.class }, new Object[]{ mc });
				...
				if (erpflmCheck == 2) {
					entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiL"), new Class[]{ Minecraft.class }, new Object[]{ mc });
				...
				if (erpflmCheck == 3) {
					...
					if(isShaders) {
//-@-125
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShaders"), new Class[]{ Minecraft.class }, new Object[]{ mc });
						s3 = "PFLM_EntityRendererShaders";
//@-@125

*///125delete
/*//125delete
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShadersHDM"), new Class[]{ Minecraft.class }, new Object[]{ mc });
						s3 = "PFLM_EntityRendererShadersHDM";
*///125delete
/*//125delete
					} else {
//-@-125
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHD"), new Class[]{ Minecraft.class }, new Object[]{ mc });
						s3 = "PFLM_EntityRendererOptiHD";
//@-@125
*///125delete
/*//125delete
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDM"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
/*//125delete
				...
				if (erpflmCheck == 4) {
					...
					if(isShaders) {
						//-@-125
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShadersHDU"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
//-@-125
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDU"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
/*//125delete
					...
					if (erpflmCheck == 5) {
						...
						if(isShaders) {
//-@-125
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShadersHDU3"), new Class[]{ Minecraft.class }, new Object[]{ mc });
							s3 = "PFLM_EntityRendererShadersHDU3";
//@-@125
*///125delete
/*//125delete
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShadersC"), new Class[]{ Minecraft.class }, new Object[]{ mc });
							s3 = "PFLM_EntityRendererShadersC";
*///125delete
/*//125delete
						} else {
//-@-125
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDU3"), new Class[]{ Minecraft.class }, new Object[]{ mc });
							s3 = "PFLM_EntityRendererOptiHDU3";
//@-@125
*///125delete
/*//125delete
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDC"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
*///125delete
/*//125delete
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShadersHDMTC"), new Class[]{ Minecraft.class }, new Object[]{ mc });
							s3 = "PFLM_EntityRendererShadersHDMTC";
*///125delete
/*//125delete
						} else {
//-@-125
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDU2"), new Class[]{ Minecraft.class }, new Object[]{ mc });
							s3 = "PFLM_EntityRendererOptiHDU2";
//@-@125
*///125delete
/*//125delete
							entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererOptiHDMTC"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
/*//125delete
					...
					if(isShader) {
//-@-110
						entityRenderer = (EntityRenderer) Modchu_Reflect.newInstance(mod_Modchu_ModchuLib.mod_modchu_modchulib.getClassName("PFLM_EntityRendererShader"), new Class[]{ Minecraft.class }, new Object[]{ mc });
...
*/
	...
	public static Object getMinecraft() {
		...
		if (o != null) return o;
		return getPFLMVersion() > 129 ? Modchu_Reflect.getPrivateValue("Minecraft", null, 8)
				: Modchu_Reflect.getPrivateValue("net.minecraft.client.Minecraft", null, 1);
	}
...
/*
		...
		for(int i = 0; i < f.length; i++) {
			Modchu_Debug.Debug("getThePlayer i="+i+" "+f[i].getName());
		}
*/
	...
	public static int getPFLMVersion() {
		return mod_pflm_playerformlittlemaid.PFLMVersion;
	}
}